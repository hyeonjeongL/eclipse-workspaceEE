...
pageContext.setAttribute("string1", "LIM");
pageContext.setAttribute("string2", "현정");
...
<body>
	...
	<ul>
		<li>----EL 리터럴(상수)----</li>
		<li>정수형리터럴:${2342358} </li>
		<li>실수형리터럴:${3.148534}</li>
		<li>논리형리터럴:${true} </li>
		<li>문자형리터럴:${"문자1"}</li>
		<li>문자형리터럴:${'문자2'}</li>
		...
		<li>30대이고 키가 180 이상인가요? ${(age ge 30 and age lt 40) and height ge 180 }</li>
		<li>---------------null or size--------------</li>
		<li>${guest==null}</li>		
