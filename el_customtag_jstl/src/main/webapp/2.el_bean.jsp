...
<%
	...
	Student s = new Student(1000, "천학생", new Car(1234,"SONATA", "GREY"));
	Guest g = new Guest(100, "백백백","2022/08/16", "guest100@gmail.com", "http://www.100.co.kr","오늘은 el공부","참헷갈ㄹ리네요");
	User u = new User("guard", "1111", "가아드","guard@gamil.com");
	Date d = new Date();
