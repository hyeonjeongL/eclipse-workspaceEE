...
public class CartDaoTestMain {
	public static void main(String[] args) throws Exception{
		...
		System.out.println(cartDao.cartProductCount(new CartItem(0, 0, new Product(3, null, 0, null, null, 0), "guard1")));
		System.out.println("--------cart add(insert)------");
		//System.out.println(cartDao.add(new CartItem(0,5, new Product(2, null, 0, null, null, 0),"guard1")));
		System.out.println("--------cart add(update)------");
		System.out.println(cartDao.updateByProductNoAndUserId(new CartItem(0, 2, new Product(1, null, 0, null, null, 0),"guard1")));
