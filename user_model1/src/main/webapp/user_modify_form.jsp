...
<%@ page language="java" contentType="text/html; charset=UTF-8"
	...
	/*
	1. UserService객체생성
	2. 세션의 sUserId를 사용해서 UserService.findUser()메소드호출
	...
	*/
	...
	User modifyUser = userService.findUser(sUserId);
								...
								<table border="0" cellpadding="0" cellspacing="1" width="590"
									...
									<tr>
										...
										<td width=490 bgcolor="ffffff" style="padding-left: 10px"
											...
											name="password" value="<%=modifyUser.getPassword()%>"></td>
									</tr>
									<tr>
										...
										<td width=490 bgcolor="ffffff" style="padding-left: 10px"
											align="left"><input type="text" style="width: 150px"
											name="password2" value="<%=modifyUser.getPassword()%>"></td>
									</tr>
									<tr>
										<td width=100 align=center bgcolor="E6ECDE" height="22">이름</td>
										<td width=490 bgcolor="ffffff" style="padding-left: 10px"
											align="left"><input type="text" style="width: 150px"
											name="name" value="<%=modifyUser.getName()%>"></td>
									</tr>
									<tr>
										...
										<td width=490 bgcolor="ffffff" style="padding-left: 10px"
											align="left"><input type="text" style="width: 150px"
											name="email" value="<%=modifyUser.getEmail()%>"></td>
									</tr>
								</table>
							</form> <br>
