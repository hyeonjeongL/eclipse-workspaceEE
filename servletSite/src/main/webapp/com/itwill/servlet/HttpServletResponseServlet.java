...
public class HttpServletResponseServlet extends HttpServlet {
	...
	protected void service(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		if(cmd.equals("1")) {
			 ...
			 * <<redirect[방향 재지정]>>
			 * 1. 응답라인 302
			 * 2. 응답헤더 [Location:05-0..form.html(redirection url) 이 포함]
			 * 3. 응답바디데이터 없음(보낼 수 없음)
			 */
			/*
			 * 같은 싸이트(servletSite) resource
			 */
...
//			response.sendRedirect("lifecycle_image_counter.do");
			 ...
			 * 다른싸이트 resource
			 */
//			response.sendRedirect("http://www.naver.com/index.html");
//			response.sendRedirect("http://192.168.15.8/servletSite");
