...
public class JoinServlet2 extends HttpServlet {
	...
	protected void doPost(HttpServletRequest request, HttpServletResponse response)
		...
		String total = id+pass+name+addr+gender+job+hobbies;

		/*
		 * 2.Service객체 가입메쏘드호출(Service-->Dao-->DB table insert)
		 */
		...
		out.println("			<td rowspan ="+total.length()+"></td>");
		out.println("		</tr>");
		out.println("		<tr>");
		out.println("			<td>패쓰워드</td>");
		out.println("			<td>"+repass+"</td>");
		out.println("		</tr>");
		out.println("		<tr>");
