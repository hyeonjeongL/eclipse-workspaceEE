...
//		/*
//		 * 클라이언트 = 요청URL
//		 *  http://localhost/sevletSite/search.do?searchkeyword=java
//		 */
//		/*
//		 * 1. 요청객체를 사용해서 요청시 전송되는 쿼리스트링에 있는 파라메타받기
...
//		if(searchkeyword==null || searchkeyword.equals("")) {
//			/*
//			 * searchkeyword가 null인 경우==> http://localhost/sevletSite/search.do
//			 * searchkeyword가 ""(null string)인 경우==> http://localhost/sevletSite/search.do?searchkeyword=
//			 */
//			//검색어를 입력하지 않은 경우 재미있는 지식 결과를 랜덤하게 보여드립니다.
//			out.println("검색어를 입력하지 않은 경우 <br> 재미있는 지식 결과를 랜덤하게 보여드립니다.<hr>");
//			out.println("<a href='05-00.search_form.html'>검색홈페이지</a>");
